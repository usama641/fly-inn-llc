      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div className="flex items-end ">
          <button
            type="button"
            onClick={findAddress}
            className="h-[40px] flex gap-3 items-center justify-center w-full border-none rounded-md bg-gradient-to-r from-red-600 to-red-700 px-4 py-2 font-medium text-white text-center shadow-md transition-all duration-300 hover:from-red-700 hover:to-red-800"
          >
            <FaMapMarkedAlt />
            Find Address
          </button>
